...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Blogs<a href="{{route('admin.show-add-blogs')}}" class="btn btn-add btn-md float-right"><i class="fa-solid fa-plus" style="margin-right: 6px"></i>Thêm</a></h2>
        </div>
        <div class="card-body">
            @if(session('msg'))
                    ...
                    @if(!empty($blogs))
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('admin.show-edit-blogs', ['id' => $item->id])}}" class="btn btn-back btn-sm"><i class="fa-regular fa-pen-to-square"></i></a>
                            </td>
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-delete btn-sm deleteBlogBtn" value="{{ $item->id }}" data-toggle="modal" data-target="#deleteModal"><i class="fa-regular fa-trash-can"></i></button>
                                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <form action="{{route('admin.delete-blogs')}}" method="POST">
                                            @csrf
                                            ...
                                            <div class="modal-body">
                                                <input type="text" name="blog_delete_id" id="blog_id">
